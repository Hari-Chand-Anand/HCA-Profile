...
export default function HomePage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-surface text-ink">
      ...
      <section className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 py-14 sm:px-8 sm:py-20 lg:px-12">
        ...
        <div className="mx-auto mt-12 grid w-full max-w-4xl gap-6 sm:mt-16">
